        ...
        <div className="flex items-center h-16 gap-4">
            ...
            <div className="hidden md:flex flex-1 max-w-xl relative">
              <div className="relative w-full">
                ...
                <input
                  ...
                  className="w-full bg-gray-100/70 border border-gray-200/50 rounded-full py-2.5 pl-10 pr-4 text-sm focus:outline-none focus:ring-2 focus:ring-primary/30 focus:bg-white focus:border-transparent transition-all"
                  value={searchQuery}
          ...
          {!isAdminPage && (
            <div className="flex items-center gap-1 sm:gap-2">
              ...
              <button
                onClick={toggleCart}
                className="relative flex items-center gap-1.5 bg-primary text-white px-4 py-2 rounded-full text-sm font-medium hover:bg-primary-dark hover:shadow-soft transition-all active:scale-95"
              >
